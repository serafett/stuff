...
\end{lstlisting}
Using a single asterisk (*) character any place in the name, different instances of Maps, Queues and Topics can be configured by a single configuration. This wildcard configuration can be used like this:
\begin{lstlisting}[language=java]
