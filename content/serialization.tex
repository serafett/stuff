...
public class Member {
    public static void main(String[] args) {
        ...
        Map<String, Person> map = hi.getMap("map");
...
\end{lstlisting}
There can only be a single global serializer and for this global serializer the getTypeId method doesn't need to return a relevant value.
