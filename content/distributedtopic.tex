...
\empth{Overflow:} When messages are send faster than they are consumed, it can lead to problems. The send will block until space becomes available [todo: is this true since an operation has a timeout]. 
