...
public class ProducerMember {
    public static void main(String[] args) throws Exception {
        ...
        IQueue<Integer> queue = hi.getQueue("queue");
        for (int k = 1; k < 100; k++) {
            queue.put(k);
...
public class WriteMember {
   public static void main(String[] args) {
      HazelcastInstance hi = Hazelcast.newHazelcastInstance();
      IList<String> list = hi.getList("list");
      list.add("Tokyo");
      list.add("Paris");
      list.add("New York");
...
public class ItemListenerMember {
   public static void main(String[] args) throws Exception {
      HazelcastInstance hi = Hazelcast.newHazelcastInstance();
      ICollection<String> q = hi.getQueue("queue");
...
public class CollectionChangeMember{
   public static void main(String[] args) throws Exception {
      HazelcastInstance hi = Hazelcast.newHazelcastInstance();
      BlockingQueue<String> q = hi.getQueue("queue");
      q.put("foo");
      q.put("bar");
      q.take();
      q.take();
