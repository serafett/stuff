...
First start up the ItemListener and wait till it displays "ItemListener started". After that start the CollectionChangeMember and you will see the following output in the ItemListenerMember:
\begin{verbatim}
item added:foo
item added:bar
item removed:foo
